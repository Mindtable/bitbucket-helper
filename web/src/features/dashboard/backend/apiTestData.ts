...
const action = {
  ...
  pullRequestId: 'pr_expected',
  repositoryId: 'repo_payments',
  repositoryDisplayName: 'Payments',
  pullRequestNumber: 42,
  pullRequestTitle: 'Improve mapper',
  activityVersion: 'av_comment_1',
  kind: 'COMMENT',
  actor: { stableId: 'u_mira', displayName: 'Mira' },
  activityAt: '2026-08-15T10:00:00Z',
  state: 'open',
  acknowledgedAt: null,
...
const card = {
  ...
  repositoryId: 'repo_payments',
  upstreamNumber: 42,
  title: 'Improve mapper',
  author: { stableId: 'u_mira', displayName: 'Mira' },
  draft: false,
  createdAt: '2026-08-15T09:00:00Z',
  updatedAt: '2026-08-15T10:00:00Z',
  webUrl: 'https://bitbucket.org/mindtable/payments/pull-requests/42',
  readiness: { type: 'available', passed: 6, total: 7, checks },
  buildState: 'successful',
  actionableItemCount: 1,
  acknowledgedItemCount: 0,
  actionItems: [action, closedAction],
}

const snapshot = {
  dashboardRevision: 'dr_dashboard_1',
  generatedAt: '2026-08-15T10:01:00Z',
  workspace: {
    workspaceId: 'ws_mindtable',
    bitbucketApiBaseUrl: 'https://api.bitbucket.org',
    workspaceSlug: 'mindtable',
    workspaceDisplayName: 'Mindtable',
    workspaceWebUrl: 'https://bitbucket.org/mindtable',
    retentionDays: 30,
    repositories: [],
  },
  repositoryGroups: [
    {
      ...
      webUrl: 'https://bitbucket.org/mindtable/payments',
      repositoryRevision: 'rrev_1',
      synchronization: {
        repositoryId: 'repo_payments',
        activity: 'running',
        lastAttemptAt: '2026-08-15T10:00:00Z',
  ...
  inbox: { items: [action, closedAction] },
...
export function pullRequestFoundResult(pullRequestId = 'pr_expected'): PullRequestDetailResult {
  ...
  return {
    ...
    pullRequest: {
      pullRequest,
      headCommit: 'abc123',
      builds: [{ key: 'build_1', state: 'successful' }],
      freshness: { type: 'fresh', snapshotAt: '2026-08-15T10:00:00Z', ageMilliseconds: 0 },
    },
...
export function contentResult(
  type:
    ...
    | 'actionItemNotFound' = 'contentAvailable',
): LiveActivityContentResult {
  ...
  switch (type) {
    case 'contentAvailable':
      return {
        ...
        ...base,
        markdown: '# Hello',
        fetchedAt: '2026-08-15T10:02:00Z',
      } as unknown as LiveActivityContentResult
    ...
    case 'staleActivityVersion':
      return {
        type,
        ...base,
        current: { ...action, activityVersion: 'av_comment_2' },
      } as unknown as LiveActivityContentResult
    case 'actionItemNotFound':
      return { type, ...base } as unknown as LiveActivityContentResult
  }
}

export function acknowledgmentResult(
  type:
    | 'acknowledged'
    | 'alreadyAcknowledged'
    | 'staleActivityVersion'
    | 'acknowledgmentRejected'
    | 'actionItemNotFound' = 'acknowledged',
): AcknowledgeActionItemResult {
  const base = { actionItemId: 'ai_comment', requestedVersion: 'av_comment_1' }
  switch (type) {
    case 'acknowledged':
      return {
        type,
        ...base,
        acknowledgedAt: '2026-08-15T10:02:00Z',
      } as unknown as AcknowledgeActionItemResult
    case 'alreadyAcknowledged':
      return { type, ...base } as unknown as AcknowledgeActionItemResult
    case 'staleActivityVersion':
      return {
        type,
        ...base,
        currentActivityVersion: 'av_comment_2',
        hasNewerActivity: true,
      } as unknown as AcknowledgeActionItemResult
    case 'acknowledgmentRejected':
      return { type, ...base, reason: 'untrusted' } as unknown as AcknowledgeActionItemResult
    case 'actionItemNotFound':
      return { type, ...base } as unknown as AcknowledgeActionItemResult
  }
}
