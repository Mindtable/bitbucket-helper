 ...
 */
@Serializable
@SerialName(value = "workspaceAlreadyConfigured")

class WorkspaceAlreadyConfiguredResult (
    ...
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "workspaceAlreadyConfigured") workspaceAlreadyConfigured("workspaceAlreadyConfigured");
