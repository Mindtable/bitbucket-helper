 ...
 */
@Serializable
@SerialName(value = "repositoryAlreadyConfigured")

class RepositoryAlreadyConfiguredResult (
    ...
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "repositoryAlreadyConfigured") repositoryAlreadyConfigured("repositoryAlreadyConfigured");
